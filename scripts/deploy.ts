...
import { DAIcontractPolygon, BentoboxPolygon } from "../test/common";


async function main() {
  
      //let encodedAddresses = ethers.utils.defaultAbiCoder.encode([ "address", "address", "address", "address" ], [ "0x2Cdf4844455c7dA5112B8e48341b964FD2e67727", DAIcontractPolygon, BentoboxPolygon, BentoboxPolygon ]);
